Name "Cryptotarget100M Core (-bit)"
...
!else
InstallDir $PROGRAMFILES\Cryptotarget100M
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
VIAddVersionKey ProductName "Cryptotarget100M Core"
...
Section -Main SEC0000
    ...
    # Remove old wxwidgets-based-cryptotarget100M executable and locales:
    Delete /REBOOTOK $INSTDIR\cryptotarget100M.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\cryptotarget100M-qt.exe
    ...
    WriteRegStr HKCR "cryptotarget100M" "URL Protocol" ""
    WriteRegStr HKCR "cryptotarget100M" "" "URL:Cryptotarget100M"
    WriteRegStr HKCR "cryptotarget100M\DefaultIcon" "" $INSTDIR\cryptotarget100M-qt.exe
    WriteRegStr HKCR "cryptotarget100M\shell\open\command" "" '"$INSTDIR\cryptotarget100M-qt.exe" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\cryptotarget100M-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMSTARTUP\Cryptotarget100M.lnk"
    ...
    DeleteRegKey HKCR "cryptotarget100M"
