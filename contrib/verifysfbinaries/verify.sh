...
WORKINGDIR="/tmp/cryptotarget100M"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/cryptotarget100M/Cryptotarget100M/cryptotarget100M-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/cryptotarget100M/Cryptotarget100M/"
VERSIONPREFIX="cryptotarget100M-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'cryptotarget100M-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[cryptotarget100M-]<version>-[rc[0-9]] (example: cryptotarget100M-0.7.1-rc1)"
   echo "wget output:"
