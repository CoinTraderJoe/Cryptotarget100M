...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old Cryptotarget100MPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/Cryptotarget100MdComparisonTool_jar/Cryptotarget100MdComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/cryptotarget100M/cryptotarget100M.git")
...
environ_default("BUILD_PATH", "/mnt/cryptotarget100M")
...
environ_default("GITHUB_REPO", "cryptotarget100M/cryptotarget100M")
