...
pkgdatadir = $(datadir)/cryptotarget100M
pkgincludedir = $(includedir)/cryptotarget100M
pkglibdir = $(libdir)/cryptotarget100M
pkglibexecdir = $(libexecdir)/cryptotarget100M
...
am__aclocal_m4_deps = $(top_srcdir)/src/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/src/m4/cryptotarget100M_find_bdb48.m4 \
	$(top_srcdir)/src/m4/cryptotarget100M_qt.m4 \
	$(top_srcdir)/src/m4/cryptotarget100M_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/cryptotarget100M-config.h
CONFIG_CLEAN_FILES = share/setup.nsi share/qt/Info.plist \
	qa/pull-tester/run-cryptotarget100Md-for-test.sh \
...
share/qt/Info.plist: $(top_builddir)/config.status $(top_srcdir)/share/qt/Info.plist.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
qa/pull-tester/run-cryptotarget100Md-for-test.sh: $(top_builddir)/config.status $(top_srcdir)/qa/pull-tester/run-cryptotarget100Md-for-test.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
