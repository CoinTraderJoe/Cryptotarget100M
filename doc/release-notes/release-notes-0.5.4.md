Cryptotarget100M version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cryptotarget100M/files/Cryptotarget100M/cryptotarget100M-0.5.4/
...
http://gitorious.org/cryptotarget100M/cryptotarget100Md-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Cryptotarget100M-Qt notifications under Growl 1.3.
Increase required age of Cryptotarget100M-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCryptotarget100M properly when installing Cryptotarget100M-Qt over it. (Windows)
