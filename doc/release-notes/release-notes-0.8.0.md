Cryptotarget100M-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cryptotarget100M/files/Cryptotarget100M/cryptotarget100M-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Cryptotarget100M
...
New/changed settings (command-line or cryptotarget100M.conf file)
--------------------------------------------------------
