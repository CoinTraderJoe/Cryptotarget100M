Download URL: https://sourceforge.net/projects/cryptotarget100M/files/Cryptotarget100M/cryptotarget100M-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CRT100M fee schedule (users still pay 0.01 CRT100M per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #cryptotarget100M00 - #cryptotarget100M99
