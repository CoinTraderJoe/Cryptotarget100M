...
*Setup instructions for a gitian build of Cryptotarget100M using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Cryptotarget100M
...
- [Building Cryptotarget100M](#building-cryptotarget100M)
...
Clone the git repositories for cryptotarget100M and gitian,

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/cryptotarget100M/cryptotarget100M
```
...
In [doc/release-process.md](release-process.md) in the cryptotarget100M repository under 'Fetch and build inputs'.
...
Building Cryptotarget100M
----------------

To build Cryptotarget100M (for Linux and/or Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the cryptotarget100M repository.

Output from `gbuild` will look something like

    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cryptotarget100M/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/cryptotarget100M/cryptotarget100M
...
For example:
```bash
URL=https://github.com/laanwj/cryptotarget100M.git
COMMIT=2014_03_windows_unicode_path
./bin/gbuild --commit cryptotarget100M=${COMMIT} --url cryptotarget100M=${URL} ../cryptotarget100M/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit cryptotarget100M=${COMMIT} --url cryptotarget100M=${URL} ../cryptotarget100M/contrib/gitian-descriptors/gitian-win.yml
```
...
```bash
    gpg --detach-sign ${VERSION}/${SIGNER}/cryptotarget100M-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cryptotarget100M-build.assert
```
...
[cryptotarget100M/gitian.sigs](https://github.com/cryptotarget100M/gitian.sigs/) repository, or
