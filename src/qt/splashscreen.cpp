    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString titleText       = tr("Cryptotarget100M Core");
    QString versionText     = QString("Version %1").arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightText   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Cryptotarget100M Core developers"));
