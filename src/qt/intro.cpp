...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/cryptotarget100M"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cryptotarget100M"),
     ...
     * override -datadir in the cryptotarget100M.conf file in the default data directory
     * (to be consistent with cryptotarget100Md behavior)
     */
    if(dataDir != getDefaultDataDirectory())
