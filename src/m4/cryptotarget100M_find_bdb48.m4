AC_DEFUN([CRYPTOTARGET100M_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    CRYPTOTARGET100M_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    CRYPTOTARGET100M_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi
