...
#if defined(NDEBUG)
# error "Cryptotarget100M cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Cryptotarget100M Signed Message:\n";
...
{
    int64_t nSubsidy = 4000000000 + nHeight; 
	
	 if (nHeight == 1)
    {
        nSubsidy = 299999999999999  + nHeight;  // Premine
    }
    else if (nHeight > 1)
    {
        nSubsidy = 4000000000 + nHeight; 
...
static const int64_t nTargetTimespan = 40; // 4 blocks
...
void ThreadScriptCheck() {
    RenameThread("cryptotarget100M-scriptch");
