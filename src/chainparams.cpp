...
// Copyright (c) 2009-2014 The Cryptotarget developers
...
public:
    CMainParams() {
        ...
        //   vMerkleTree: 4a5e1e
        const char* pszTimestamp = "Cryptotarget Genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1417792650;
        genesis.nBits    = 0x1d00ffff;
        genesis.nNonce   = 1415905246;
        ...
        vSeeds.push_back(CDNSSeedData("cryptotarget.com", "dns.cryptotarget.com"));
