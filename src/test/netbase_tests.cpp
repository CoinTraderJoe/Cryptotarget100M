...
{
    BOOST_CHECK(TestSplitHost("www.cryptotarget100M.org", "www.cryptotarget100M.org", -1));
    BOOST_CHECK(TestSplitHost("[www.cryptotarget100M.org]", "www.cryptotarget100M.org", -1));
    BOOST_CHECK(TestSplitHost("www.cryptotarget100M.org:80", "www.cryptotarget100M.org", 80));
    BOOST_CHECK(TestSplitHost("[www.cryptotarget100M.org]:80", "www.cryptotarget100M.org", 80));
