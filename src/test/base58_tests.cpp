// Copyright (c) 2011-2014 The Cryptotarget100M Core developers
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_parse)
{
    ...
    std::vector<unsigned char> result;
    CCryptotarget100MSecret secret;
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        if(isPrivkey)
        {
            ...
            // Note: CCryptotarget100MSecret::SetString tests isValid, whereas CCryptotarget100MAddress does not!
...
BOOST_AUTO_TEST_CASE(base58_keys_valid_gen)
{
    ...
    BOOST_FOREACH(Value& tv, tests)
    {
        ...
        else
        {
            ...
            CCryptotarget100MAddress addrOut;
    ...
    CCryptotarget100MAddress dummyAddr;
