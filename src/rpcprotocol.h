...
#ifndef _CRYPTOTARGET100MRPC_PROTOCOL_H_
#define _CRYPTOTARGET100MRPC_PROTOCOL_H_ 1
...
// Cryptotarget100M RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Cryptotarget100M is not connected
